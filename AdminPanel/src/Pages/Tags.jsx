...
export const Tags = () => {
    ...
    const sellData = async (v) => {
        setDataPoint((await axios.get('/api/admin/get_Tag')).data)
    }
        ...
        <div style={{ width: "90%", margin: "0 auto" }}>
            ...
            >
                ...
                <Column flexGrow={1} align="left" fullText>
                    <HeaderCell>Название тега</HeaderCell>
                    <Cell dataKey="Tag_Name" />
                </Column>
                <Column flexGrow={1} align="left" fullText>
                    <HeaderCell>Цвет</HeaderCell>
                    <Cell dataKey="Color" >
                        {
                            rowData => <Tag color={rowData.Color}>{rowData.Color}</Tag>
                        }
                    </Cell>
                </Column>
